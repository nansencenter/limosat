...
OUTPUT="$ROOT/icesat2_validation/results/selected_expansion_v1/pair_10245_10352"
PAIR_START=2020-03-28T12:13:29Z
PAIR_END=2020-03-29T11:16:05Z
REASON="Frozen 2026-08-19 March expansion: Version 7 granule intersects the SAR interval and its CMR footprint overlaps the deformation domain; selected before download and before any deformation association."
...
do
  ...
  "$PYTHON" experiments/validate_icesat2_deformation.py \
    ...
    --candidate-inclusion-reason "$REASON" \
    --analysis-role confirmation \
